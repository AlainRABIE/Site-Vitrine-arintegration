...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Page actes et tarifs détaillée',
      'Newsletter patients (optionnelle)',
  ...
  },
  {
    ...
    features: [
      ...
      'Espace patient sécurisé (téléchargement ordonnances)',
      'Synchronisation Google Calendar du praticien',
      '3 articles SEO médical rédigés',
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
        ...
        <Reveal delay={0.3}>
          <p className="mt-10 text-center text-[14px] text-muted dark:text-white/60">
            💼 Besoin d'un site pour cabinet de groupe (5+ praticiens) ou MSP ?{' '}
