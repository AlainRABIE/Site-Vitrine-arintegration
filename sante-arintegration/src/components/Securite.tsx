import { Flag, Lock, Hospital, ScrollText } from 'lucide-react'
...
const ITEMS = [
  ...
  {
    icon: Hospital,
    title: 'Compatible HDS',
    text: 'Hébergement de Données de Santé certifié sur demande.',
  },
  {
    icon: ScrollText,
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
        <Reveal>
          <h2 className="heading-section mx-auto max-w-3xl text-center text-[34px] text-white md:text-[48px]">
            Vos données patients hébergées en France, comme la loi l'exige.
          </h2>
        </Reveal>
