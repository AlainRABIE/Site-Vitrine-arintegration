...
export const metadata: Metadata = {
  title: 'Contact — Réserver un appel 15 min | AR Intégration',
  description: "Réservez un appel découverte de 15 minutes. Sans engagement, sans bullshit. Réponse sous 24h ouvrées.",
