...
export const metadata: Metadata = {
  ...
  description: "Politique de confidentialité du site medecins.arintegration.fr. Conforme RGPD et loi Informatique et Libertés.",
      ...
      <main>
        <article className="mx-auto max-w-3xl px-5 py-16 md:px-8 md:py-20">
          ...
          <p className="mt-5 text-[15.5px] leading-relaxed text-muted dark:text-white/70">
            En vigueur au 9 mai 2026. Conforme au Règlement Général sur la Protection des Données
            (RGPD — UE 2016/679) et à la loi Informatique et Libertés modifiée.
          </p>

          <div className="mt-10">
            <Section title="Mention spéciale santé">
              <p>
                <strong className="text-ink dark:text-white">Aucune donnée de santé n'est collectée via ce site de présentation.</strong>{' '}
                Les formulaires de contact collectent uniquement nom, email professionnel, téléphone
                et message, à des fins exclusives de prise de contact commercial.
              </p>
              <p>
                Les sites livrés à nos clients praticiens peuvent, sur demande explicite, intégrer
                des modules de prise de RDV (Calendly, Doctolib, ou natif HDS). Dans ce cas, le
                traitement des données patients est encadré par un contrat distinct et un hébergement
                certifié HDS.
              </p>
            </Section>
            ...
            <Section title="Données collectées et finalités">
              <p>
                ...
                spécialité, nombre de praticiens, offre intéressée, créneau préféré, message libre.
