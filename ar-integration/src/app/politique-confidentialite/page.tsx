...
export const metadata: Metadata = {
  ...
  description: "Politique de confidentialité du site arintegration.fr. Conforme RGPD et loi Informatique et Libertés.",
          ...
          <div className="mt-10">
            ...
            <Section title="Données collectées et finalités">
              <p>
                ...
                entreprise, type de projet, budget, offre intéressée, créneau préféré, message libre.
