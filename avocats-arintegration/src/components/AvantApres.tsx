...
const AVANT = [
  "Site qui n'est pas mobile (la majorité de vos clients consultent sur smartphone)",
  'Pas de prise de RDV en ligne (vous saturez votre secrétariat)',
  'Hébergement étranger (non conforme RGPD pour données clients)',
  'Aucun contrôle sur les modifications (cher et long à chaque changement)',
  'Pas de référencement local (vos clients ne vous trouvent pas sur Google)',
]

const APRES = [
  'Site responsive parfait sur mobile, tablette, ordinateur',
  'Module de prise de RDV intégré (Calendly ou widget natif)',
  'Hébergement OVH France, conforme RGPD et secret professionnel',
  'Modifications prises en charge sous 48h par votre développeur dédié, sans agence intermédiaire',
  'Optimisé « Avocat [Spécialité] [Ville] » sur Google Maps et recherche locale',
]
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
        <Reveal>
          <h2 className="heading-section mx-auto max-w-3xl text-center text-[34px] text-ink dark:text-white md:text-[48px]">
            Vos clients méritent mieux qu'un site daté de 2015.
          </h2>
        </Reveal>
