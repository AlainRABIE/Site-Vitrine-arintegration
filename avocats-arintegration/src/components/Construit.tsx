...
const FEATURES = [
  {
    ...
    text: 'Intégration Calendly ou widget natif pour fluidifier la prise de premier RDV sans saturer votre secrétariat.',
  },
  {
    icon: MapPin,
    title: 'Carte interactive et itinéraire',
    text: 'Vos clients trouvent le cabinet en un clic, depuis leur téléphone ou leur ordinateur.',
  },
  {
    icon: Users,
    title: 'Page équipe',
    text: 'Avocats, collaborateurs, secrétariat — avec photos professionnelles et présentation claire.',
  },
  {
    icon: FileText,
    title: "Domaines d'intervention et honoraires",
    text: "Transparence pré-contractuelle : vos domaines, vos modalités d'honoraires, conformes au RIN.",
  },
  {
    icon: MessageSquare,
  ...
  },
  {
    ...
    text: 'Décisions remarquables, conseils juridiques, jurisprudences récentes en quelques clics.',
  },
]
