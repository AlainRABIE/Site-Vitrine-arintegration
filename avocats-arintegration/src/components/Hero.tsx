  ...
  return (
    <section className="relative overflow-hidden border-b border-line dark:border-white/10">
      <div className="mx-auto max-w-6xl px-5 py-14 text-center md:px-8 md:py-20 lg:py-24">
        ...
        >
          Votre cabinet d'avocats mérite un site qui inspire confiance dès la première seconde.
        </motion.h1>
        ...
        >
          Sites web professionnels pour avocats, juristes et cabinets de droit. Conformes RGPD, hébergés en France, livrés en 7 jours.
        </motion.p>
