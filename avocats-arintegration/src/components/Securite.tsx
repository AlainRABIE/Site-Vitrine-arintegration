import { Flag, Lock, Scale, ScrollText } from 'lucide-react'
...
const ITEMS = [
  ...
  {
    icon: Scale,
    title: 'Compatible secret professionnel',
    text: 'Aucun service tiers étranger sans votre accord — RIN article 2.',
  },
  {
    icon: ScrollText,
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
        <Reveal>
          <h2 className="heading-section mx-auto max-w-3xl text-center text-[34px] text-white md:text-[48px]">
            Vos données clients hébergées en France, comme l'exige le secret professionnel.
          </h2>
        </Reveal>
