...
const CARDS = [
  {
    ...
    value: 78,
    suffix: '%',
    label: 'des justiciables consultent Google avant de choisir un avocat',
    source: 'Source : Conseil National des Barreaux 2023',
    text: "Si vous n'apparaissez pas, ou si votre site fait peur, ils prennent un autre confrère.",
  },
  {
    icon: TrendingDown,
    value: 53,
    ...
    text: "Un site lent = clients perdus avant même d'avoir vu votre nom.",
  },
  {
    icon: Shield,
    value: 20,
    suffix: 'M€',
    label: 'Amende CNIL maximum pour non-conformité RGPD données clients',
    source: 'Source : Article 83 RGPD',
    text: 'Vos données clients hébergées hors UE peuvent vous coûter votre clientèle et votre réputation.',
  },
]
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
        <Reveal>
          <h2 className="heading-section mx-auto max-w-3xl text-center text-[34px] text-ink dark:text-white md:text-[48px]">
            Sans site moderne, vous perdez 3 dossiers par mois.
          </h2>
        </Reveal>
