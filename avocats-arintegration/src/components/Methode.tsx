...
const STEPS = [
  {
    ...
    text: "On échange par téléphone à l'horaire qui vous arrange (entre 2 audiences ou en fin de journée). Vous nous présentez votre cabinet, vos besoins, votre budget. Sans engagement.",
  },
  {
    n: '02',
  ...
  },
  {
    ...
    text: 'Site en ligne. On fait le point ensemble sur le module RDV (Calendly) et la prise en main du quotidien. Toute évolution du contenu passe par AR Intégration, traitée sous 48h ouvrées. Support inclus pendant 3 mois minimum.',
  },
]
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
        <Reveal>
          <h2 className="heading-section mx-auto max-w-3xl text-center text-[34px] text-ink dark:text-white md:text-[48px]">
            Un processus simple, conçu pour les avocats occupés.
          </h2>
        </Reveal>
