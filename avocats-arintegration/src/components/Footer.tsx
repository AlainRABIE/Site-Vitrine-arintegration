...
const COL_SOLUTIONS = [
  { label: "Site cabinet d'avocats", href: '/contact?offre=cabinet' },
  { label: 'Site notaire', href: '/contact?offre=notaire' },
  { label: 'Site cabinet généraliste', href: '/contact?offre=generaliste' },
  { label: 'Site cabinet de groupe', href: '/contact?offre=groupe' },
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-5 max-w-xs text-[14px] leading-relaxed text-white/70">
              Développement web et mobile pour professionnels du droit.
            </p>
