...
export const metadata: Metadata = {
  ...
  description: "Politique de confidentialité du site avocats.arintegration.fr. Conforme RGPD et loi Informatique et Libertés.",
    ...
    <>
      ...
      <main>
        <article className="mx-auto max-w-3xl px-5 py-16 md:px-8 md:py-20">
          ...
          <div className="mt-10">
            <Section title="Mention spéciale professions du droit">
              <p>
                <strong className="text-ink dark:text-white">Aucune donnée client n'est collectée via ce site de présentation.</strong>{' '}
                Les formulaires de contact collectent uniquement nom, email professionnel, téléphone
                et message, à des fins exclusives de prise de contact commercial avec le cabinet
                AR Intégration.
              </p>
              <p>
                Les sites livrés à nos clients avocats peuvent intégrer des modules de prise de RDV
                (Calendly) ou des formulaires de contact dédiés. Dans ce cas, le traitement des
                données prospects/clients du cabinet est encadré par un contrat distinct et soumis
                au secret professionnel applicable au cabinet utilisateur.
              </p>
            </Section>
            ...
            <Section title="Données collectées et finalités">
              <p>
                ...
                spécialité, nombre d'avocats, offre intéressée, créneau préféré, message libre.
