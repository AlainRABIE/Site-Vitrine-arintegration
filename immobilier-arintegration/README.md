# immobilier.arintegration.fr

Landing page sectorielle dédiée aux agences immobilières, mandataires et conseillers.
Sous-domaine de [arintegration.fr](https://arintegration.fr).
...
| `NEXT_PUBLIC_APP_URL` | URL canonique (par défaut `https://immobilier.arintegration.fr`) |
...
Vercel : `output: 'export'`. Pour le sous-domaine `immobilier.arintegration.fr`,
pointer le CNAME vers Vercel et ajouter le domaine dans Project Settings → Domains.

## Conformité

- Mention "conforme loi Hoguet" (mandats, mentions obligatoires, carte T) dans Securite
