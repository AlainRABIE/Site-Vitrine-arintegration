...
const COL_SOLUTIONS = [
  { label: 'Site agence immobilière', href: '/contact?offre=agence' },
  { label: 'Site mandataire indépendant', href: '/contact?offre=mandataire' },
  { label: 'Site conseiller immobilier', href: '/contact?offre=conseiller' },
  { label: "Site réseau d'agences", href: '/contact?offre=groupe' },
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-5 max-w-xs text-[14px] leading-relaxed text-white/70">
              Développement web et mobile pour professionnels de l'immobilier.
            </p>
