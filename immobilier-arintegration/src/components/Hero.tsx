  ...
  return (
    <section className="relative overflow-hidden border-b border-line dark:border-white/10">
      <div className="mx-auto max-w-6xl px-5 py-14 text-center md:px-8 md:py-20 lg:py-24">
        ...
        >
          Votre agence immobilière mérite un site qui convertit dès la première visite.
        </motion.h1>
        ...
        >
          Sites web professionnels pour agences immobilières, mandataires et conseillers. Conformes RGPD, hébergés en France, livrés en 7 jours.
        </motion.p>
