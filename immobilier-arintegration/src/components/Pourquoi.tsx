...
const CARDS = [
  {
    ...
    value: 97,
    suffix: '%',
    label: 'des acheteurs commencent leur recherche immobilière en ligne',
    source: 'Source : FNAIM 2024',
    text: "Si vous n'apparaissez pas, ou si votre site fait peur, ils contactent une autre agence.",
  },
  {
    icon: TrendingDown,
    value: 53,
    ...
    text: "Un site lent = vendeurs perdus avant même d'avoir vu votre nom.",
  },
  {
    icon: Shield,
    value: 20,
    suffix: 'M€',
    label: 'Amende CNIL maximum pour non-conformité RGPD données prospects',
    source: 'Source : Article 83 RGPD',
    text: "Vos données vendeurs/acheteurs hébergées hors UE peuvent vous coûter votre carte T.",
  },
]
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
        <Reveal>
          <h2 className="heading-section mx-auto max-w-3xl text-center text-[34px] text-ink dark:text-white md:text-[48px]">
            Sans site moderne, vous perdez 5 mandats par mois.
          </h2>
        </Reveal>
