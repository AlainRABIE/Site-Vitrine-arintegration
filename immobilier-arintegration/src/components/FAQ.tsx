...
const QA = [
  {
    ...
    a: "7 jours ouvrés à compter de la validation du devis pour l'offre Essentielle. 10 jours pour Agence Connectée. Engagement contractuel.",
  },
  {
  ...
  },
  {
    ...
    a: "Oui. Optimisation SEO local incluse (Google My Business, Schema.org RealEstateAgent, balises meta, Schema.org pour fiches biens). Pour un référencement national avancé, l'offre Agence Premium inclut 3 articles SEO immobilier rédigés par nos soins.",
  },
  {
    q: "Quelle est la différence avec SeLoger, Bien'ici, ou un site fait sur Wix ?",
    a: "Les portails (SeLoger, Bien'ici, Logic-Immo) sont des plateformes de diffusion où vous payez à l'annonce et où les leads vous échappent au profit du portail. Wix est limité, lent, non conforme RGPD par défaut. Notre solution : votre site, vos leads, vos données en France, code sur-mesure, zéro commission sur les nouveaux mandats.",
  },
  {
    q: 'Que se passe-t-il après les 3 mois de maintenance ?',
    a: 'Vous passez en formule maintenance à 200€/mois, qui inclut les légères modifications de contenu (équipe, services, honoraires, actualités), les mises à jour de sécurité et le support technique. Vous restez propriétaire à 100% du site et du code.',
  },
  {
      ...
      <div className="mx-auto max-w-3xl px-5 py-20 md:px-8 md:py-28">
        <Reveal>
          <h2 className="heading-section text-center text-[34px] text-ink dark:text-white md:text-[48px]">
            Questions fréquentes des agents immobiliers.
          </h2>
        </Reveal>
