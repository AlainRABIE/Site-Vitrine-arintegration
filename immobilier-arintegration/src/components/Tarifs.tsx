...
const PLANS: Plan[] = [
  {
    ...
    intent: 'essentielle',
    features: [
      "Site 4 pages (Accueil, Agence, Équipe, Contact)",
      'Mobile-first responsive',
      'Formulaire estimation + contact RGPD',
  ...
  },
  {
    ...
    features: [
      ...
      'Module fiches biens (sync Hektor / ImmoFacile / Apimo)',
      'Page équipe étendue avec photos pros',
      'Page services et honoraires détaillée',
      'Newsletter prospects (optionnelle)',
  ...
  },
  {
    ...
    intent: 'premium',
    features: [
      "Tout de l'offre Agence Connectée",
      'Espace vendeur sécurisé (suivi mandat, photos, visites)',
      'Notifications nouveaux biens par alerte email',
      '3 articles SEO immobilier rédigés',
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
        ...
        <Reveal delay={0.05}>
          <div className="mx-auto mt-8 flex w-fit max-w-full items-center gap-2.5 rounded-full border border-ink bg-ink-soft px-4 py-2 text-[13px] font-semibold text-white dark:border-white/30">
            ...
            <span>Tarifs de lancement <strong>−30 %</strong> · 10 premières agences · jusqu'au 31 mars 2026</span>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.3}>
          <p className="mt-10 text-center text-[14px] text-muted dark:text-white/60">
            💼 Besoin d'un site pour réseau d'agences (3+ points de vente) ou portefeuille luxe ?{' '}
