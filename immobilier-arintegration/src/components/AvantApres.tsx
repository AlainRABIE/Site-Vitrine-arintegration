...
const AVANT = [
  'Site pas mobile (90% des recherches immobilières démarrent sur smartphone)',
  'Pas de fiches biens à jour automatiquement (mises à jour manuelles chronophages)',
  'Hébergement étranger (non conforme RGPD pour données prospects)',
  'Aucun contrôle sur les modifications (cher et long à chaque changement)',
  'Pas de référencement local (vos vendeurs ne vous trouvent pas sur Google)',
]

const APRES = [
  'Site responsive parfait sur mobile, tablette, ordinateur',
  'Fiches biens synchronisées avec votre logiciel métier (Hektor, ImmoFacile, Apimo)',
  'Hébergement OVH France, conforme RGPD',
  'Modifications prises en charge sous 48h par votre développeur dédié, sans agence intermédiaire',
  'Optimisé « Agence immobilière [Ville] » sur Google Maps et recherche locale',
]
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
        <Reveal>
          <h2 className="heading-section mx-auto max-w-3xl text-center text-[34px] text-ink dark:text-white md:text-[48px]">
            Vos vendeurs et acquéreurs méritent mieux qu'un site daté de 2015.
          </h2>
        </Reveal>
