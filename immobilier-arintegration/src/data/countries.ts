...
// Liste ISO 3166-1 + indicatifs ITU-T E.164 (245 pays/territoires).
// Triée par ordre alphabétique français.
export const countries: Country[] = [
  ...
  { code: 'GS', name: 'Géorgie du Sud', dial: '+500', flag: '🇬🇸' },
  ...
  { code: 'AX', name: 'Îles Åland', dial: '+358', flag: '🇦🇽' },
  ...
  { code: 'PN', name: 'Îles Pitcairn', dial: '+64', flag: '🇵🇳' },
  ...
  { code: 'SX', name: 'Saint-Martin (NL)', dial: '+1721', flag: '🇸🇽' },
