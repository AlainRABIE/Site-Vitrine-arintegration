...
export const alt = 'AR Intégration — Sites web pour agences immobilières, conformes RGPD'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ fontSize: 80, fontWeight: 700, lineHeight: 1.02, letterSpacing: -3, display: 'flex', flexDirection: 'column', color: '#FFFFFF', marginBottom: 56 }}>
          <span style={{ display: 'flex' }}>Sites web pour agences.</span>
